...
<body class="sidebar-mini layout-fixed" style="height: auto;">
    ...
    <div id="fb-root"></div>
    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v7.0&appId=2337011836599499&autoLogAppEvents=1" nonce="MjXFJhZk"></script>    <script src="{{ asset('js/main.js') }}"></script>
    <script>
        $(function() {
