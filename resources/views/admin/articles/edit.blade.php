    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.articles.update", [$article->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('short_description') ? 'is-invalid' : '' }}" type="text" name="short_description" id="short_description" value="{{ old('short_description', $article->short_description) }}">
            ...
            <div class="form-group">
                <label for="media">{{ trans('cruds.article.fields.media') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.article.fields.media_helper') }}</span>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('hot') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="hot" id="hot" value="1" {{ $article->hot || old('hot', 0) === 1 ? 'checked' : '' }}>
                    <label class="form-check-label" for="hot">{{ trans('cruds.article.fields.hot') }}</label>
                </div>
                @if($errors->has('hot'))
                    <span class="text-danger">{{ $errors->first('hot') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.article.fields.hot_helper') }}</span>
            </div>
            <div class="form-group">
